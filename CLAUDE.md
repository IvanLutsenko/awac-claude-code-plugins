...
- **crashlytics** (v4.2.3) — Multi-platform crash analysis with git blame forensics
- **obsidian-tracker** (v3.1.2) — Project tracking, task management, session logging via Obsidian
