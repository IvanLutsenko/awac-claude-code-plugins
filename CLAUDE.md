...
- **crashlytics** (v4.2.2) — Multi-platform crash analysis with git blame forensics
- **obsidian-tracker** (v3.1.1) — Project tracking, task management, session logging via Obsidian
