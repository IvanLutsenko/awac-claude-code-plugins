---
name: clip-maker-clip-maker
description: Create vertical clips from a video. Full pipeline: transcribe → find moments → crop → cut → subtitles → copy. Use when the user invokes /clip-maker.
version: 0.1.0
---
