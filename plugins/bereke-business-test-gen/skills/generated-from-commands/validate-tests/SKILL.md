---
name: bereke-business-test-gen-validate-tests
description: Валидация всех unit тестов в модуле на соответствие корпоративным стандартам. Use when the user invokes /validate-tests.
version: 0.1.0
---
