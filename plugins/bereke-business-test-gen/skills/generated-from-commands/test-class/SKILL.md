---
name: bereke-business-test-gen-test-class
description: Генерация unit теста для одного класса по корпоративным стандартам. Use when the user invokes /test-class.
version: 0.1.0
---
...
**Repository (с Flow<PagingData> через Turbine):**
```kotlin
