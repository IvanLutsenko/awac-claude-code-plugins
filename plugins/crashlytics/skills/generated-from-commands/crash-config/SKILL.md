---
name: crashlytics-crash-config
description: Configure Crashlytics plugin settings (language, branch, platform, model, Firebase IDs). Use when the user invokes /crash-config.
version: 0.1.0
---
