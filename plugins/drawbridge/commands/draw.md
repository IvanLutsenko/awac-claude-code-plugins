---
description: Crafts a target-tuned image-gen prompt from a short brief, copies it to clipboard, opens the target web UI.
argument-hint: "[-t gemini|chatgpt|grok|midjourney] <brief>"
allowed-tools: Bash(source:*), Bash(${CLAUDE_PLUGIN_ROOT}/scripts/*), Bash(bash:*), Bash(pbcopy:*), Bash(open:*), Bash(printf:*), Bash(cat:*), Bash(date:*), Bash(mkdir:*), Bash(tail:*), Bash(wc:*), Bash(mv:*), Bash(awk:*), Bash(python3:*), Skill, Read
---
