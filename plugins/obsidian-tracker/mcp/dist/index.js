...
const DEFAULT_CONFIG = { initialized: false };
...
async function parseBoard(boardPath) {
...
async function writeBoard(boardPath, columns) {
    let content = "---\nkanban-plugin: basic\n---\n";
    for (const col of BOARD_COLUMNS) {
        content += `\n## ${col}\n`;
...
async function getNextTaskId(projectPath) {
    try {
...
async function getNextDecisionId(projectPath) {
...
async function updateTaskFrontmatter(taskPath, updates) {
