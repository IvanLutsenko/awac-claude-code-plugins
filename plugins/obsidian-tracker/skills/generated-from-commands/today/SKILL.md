---
name: obsidian-tracker-today
description: Show daily task dashboard across all projects. Use when the user invokes /today.
version: 0.1.0
---

> Converted from Claude Code command `/today`.
